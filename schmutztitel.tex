...
\node [text width=8cm] at (10.7,2){\includegraphics[width = 0.38\textwidth]{PTRA_logo.png}};
\centering
\node [text width=8cm] at (3,23.5){\includegraphics[width = 0.32\textwidth]{Fachschaftslogo.png}};
