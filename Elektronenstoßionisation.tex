...
\begin{equation}
    \sigma_i = \sum_{i=1}^{N} a_i n_i \frac{ \ln (\frac{E_e}{P_i}) }{E_e P_i} \left( 1 - b_i e ^{-c_i \frac{E_e}{P_i - 1}}\right)
\end{equation}
...
\begin{equation}
    N = \frac{d}{\lambda}.
\end{equation}
Wenn man eine rein klassische Abschätzung macht und die Atome als harte Kugeln annimmt, kann man den Wirkungsquerschnitt als eine Fläche mit dem Radius des Atoms beschreiben. 